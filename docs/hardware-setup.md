...
If USB provisioning is interrupted, follow the [indeterminate inventory recovery procedure](provisioning.md) before retrying. A driver error does not establish whether the device saved its credentials.
