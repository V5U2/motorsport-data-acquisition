...
NVS encryption, protected commissioning traffic, signed update enforcement, rollback, and recovery authorization are deliberately tracked by APE-82. Until that work and its physical validation are complete, restrict this firmware to controlled development hardware.
